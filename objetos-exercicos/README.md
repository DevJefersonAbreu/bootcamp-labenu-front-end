...
Esqueceu como se faz?
 Crie uma nova branch: git checkout -b <turma-nome-sobrenome-objetos>.
...
O que você precisa saber e praticar desta aula?
 item 1 - Construindo e lendo objetos
 item 2 - Acessando propriedades de objetos
 item 3 - Copiando e alterando objetos
Cada pasta deste repo possui um README.md com o enunciado do exercício e um template para que você possa começar.

Informações úteis sobre o assunto
Introdução a objetos em Javascript - Aprendendo desenvolvimento web | MDN
